...
export default function Homeprojects({ navigation }) {
  ...
  const teammembers = [
    ...
    { id: 6, picture: require("./../assets/dummypictures/coworker4.png") },
  ];
  const dropdownitems2 = [
    { label: "Saturday", value: "Saturday" },
    { label: "Sunday", value: "Saturday2" },
  ];
  const taskslist = [
    {
      id: 1,
            ...
            <SwipeListView
              ...
              renderItem={(rowData, rowMap) => (
                <View
                  ...
                  style={[
                    styles.ltask,
                    rowData.index == 0 ? styles.lfirsttask : {},
                  ]}
                >
                  <Task
                    id={rowData.item.id}
                    ...
                    onbuttonpress={() => navigation.navigate("Projectsdetails")}
              ...
              renderHiddenItem={(data, rowMap) => (
                <View
                  style={[
                    styles.ltaskactions,
                    data.index == 0 ? styles.lfirsttask : {},
                  ]}
                >
